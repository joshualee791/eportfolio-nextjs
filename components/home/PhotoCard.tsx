...
export default async function PhotoCard() {
  ...
  return (
    <Link href="/about" aria-label="About Joshua Garza" className="group block w-full max-w-xs mx-auto md:mx-0">
      <CrosshatchCard className="w-full">
        ...
        >
          {aboutImageUrl ? (
            <Image src={aboutImageUrl} alt="Headshot of Joshua Garza" fill className="object-cover" />
          ) : (
